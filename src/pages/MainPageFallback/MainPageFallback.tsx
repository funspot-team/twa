...
import { Icon16ChevronRightWhite } from '@/icons/chevronRightWhite';

import './MainPageFallback.css';
...
export const MainPageFallback: FC = () => {
  ...
  // const baner = spots.find(({id}) => 348 === Number(id));
