...
import { $filters, onResetFilters } from '@/components/Filters/model';
...
export const CatalogPage: FC = () => {
  ...
  const { loading } = useFakeLoading(500, filters);
  const data = [...SPOTS.data, ...SPOTS.data];
  const spots = getSpotsByFilters(data, filters);
